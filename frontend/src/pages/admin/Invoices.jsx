...
const STATUS_TONES = { PENDING: "amber", PAID: "green", REFUND_REQUESTED: "blue", REFUNDED: "neutral" };
const STATUS_LABELS = { PENDING: "Pending", PAID: "Paid", REFUND_REQUESTED: "Refund requested", REFUNDED: "Refunded" };
