...
export function EmployerChangePassword() {
  ...
  return (
    <div className="mx-auto max-w-xl">
      <div className="flex gap-3 mb-6">
        <span className="grid h-10 w-10 shrink-0 place-items-center rounded-full" style={{ background: EMP_SUBTLE, color: EMP }}>
          <LockKeyhole size={18} />
        </span>
        <div>
      ...
      <form onSubmit={submit} className="card-soft p-5">
        ...
        <Button className="mt-5 w-full sm:w-auto" disabled={saving} type="submit" style={{ background: EMP, borderColor: EMP }}>
